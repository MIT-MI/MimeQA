...
from eval_utils import MP4_VID_DIRECTORY, TITLE_MAPPING_DIRECTORY, TEST_VIDS, get_augmented_questions, get_model_local_path, get_fine_tune_test_vids
...
if __name__ == "__main__":
    ...
    for n_vid, vid_name in enumerate(eval_videos):
        ...
        filename = data_folder / f'qwen_text-only_{args.text_only}_fps{args.fps}_{args.max_frames}frames_title_{args.with_titles}_{seed_str}{fine_tune_test_str}annotation_generated.csv'
